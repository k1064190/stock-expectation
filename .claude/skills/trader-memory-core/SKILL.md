...
```bash
uv run python .claude/skills/trader-memory-core/scripts/thesis_ingest.py \
...
```bash
uv run python .claude/skills/trader-memory-core/scripts/thesis_store.py \
...
```bash
uv run python .claude/skills/trader-memory-core/scripts/thesis_review.py \
