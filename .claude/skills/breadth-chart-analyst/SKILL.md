...
```bash
uv run python .claude/skills/breadth-chart-analyst/scripts/fetch_breadth_csv.py
```
...
```bash
uv run python .claude/skills/breadth-chart-analyst/scripts/extract_chart_right_edge.py <image_path> --percent 25
```
...
```bash
uv run python .claude/skills/breadth-chart-analyst/scripts/detect_uptrend_ratio.py <image_path> [--debug]
```
...
```bash
uv run python .claude/skills/breadth-chart-analyst/scripts/fetch_breadth_csv.py        # Human-readable
uv run python .claude/skills/breadth-chart-analyst/scripts/fetch_breadth_csv.py --json  # JSON output
```
