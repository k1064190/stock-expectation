...
```bash
uv run python .claude/skills/edge-candidate-agent/scripts/auto_detect_candidates.py \
...
```bash
uv run python .claude/skills/edge-candidate-agent/scripts/export_candidate.py \
...
```bash
uv run python .claude/skills/edge-candidate-agent/scripts/validate_candidate.py \
