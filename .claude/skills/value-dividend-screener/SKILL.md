...
```bash
# Fetch 90 days of price data (for RSI and recent trend context)
...
1. Dividend yield >= 3% (from fundamentals-batch output)
2. P/E ratio <= 20, P/B ratio <= 2
3. Dividend growth rate (3-year CAGR) >= 5%
4. Revenue and EPS trend: positive over 3 years
5. Payout ratio < 100%, FCF coverage check
6. Debt-to-equity < 2, current ratio > 1
