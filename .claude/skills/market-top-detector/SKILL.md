...
The analysis will:
1. Use fetched price data for S&P 500, QQQ, VIX, Leading ETFs, and Sector ETFs
2. Use WebSearch-collected breadth (50DMA %) and Put/Call ratio
3. Calculate all 6 components
