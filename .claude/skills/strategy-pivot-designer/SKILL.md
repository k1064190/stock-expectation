...
```bash
uv run python .claude/skills/strategy-pivot-designer/scripts/detect_stagnation.py \
...
```bash
uv run python .claude/skills/strategy-pivot-designer/scripts/generate_pivots.py \
