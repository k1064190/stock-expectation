...
uv run python .claude/skills/signal-postmortem/scripts/postmortem_recorder.py \
  --list-ready \
...
uv run python .claude/skills/signal-postmortem/scripts/postmortem_analyzer.py \
